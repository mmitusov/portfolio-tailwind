...
Since V5 `npx create-react-app` finaly has support for TilwindCSS, amount of steps for its instalation have been [here](https://tailwindcss.com/docs/guides/create-react-app)
